...
function Game() {
  ...
  const [coord, setCoord] = useState<stageCoords>(stageconst(displayIncrement));
  const [coordInitial, setCoordInitial] = useState<stageCoords>(stageconst(displayIncrement));
  ...
  const handleAClick = (event:  KeyboardEvent|React.MouseEvent<HTMLDivElement>) => {
  ...
  const handleBClick = (event:  KeyboardEvent|React.MouseEvent<HTMLDivElement>) => {
    event.preventDefault();
    setlevel(0);
    setScore(0);
  ...
  const handleUpClick = (e: KeyboardEvent|React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
  ...
  const handleLeftClick = (e: KeyboardEvent|React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
  ...
  const handleRightClick = (e: KeyboardEvent|React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
  ...
  const handleDownClick = (e: KeyboardEvent|React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    ...
    <div>
      <div className="bigContainer">
        ...
        <div className="buttonLayout">
          ...
          <div className="a-buttonContainer btn" onClick={(e)=>handleAClick(e)}>
            <p>A</p>
          </div>

          <div className="b-buttonContainer btn" onClick={(e)=>handleBClick(e)}>
            <p>B</p>
          </div>
        </div>
      </div>
